...
<div style="background:black; color:white; padding:15px; border-radius:8px; display:flex; align-items:center;">
<img src="https://marketplace.canva.com/Mro0Y/MAFOpzMro0Y/1/tl/canva-objective-MAFOpzMro0Y.png" style="height:30px; padding-right: 10px;" ></img>
    <p style="color:white; margin:0; font-size:20px;font-weight:bold">Intenção do Projeto:</p>
</div>
...
##
<div style="background:black; color:white; padding:15px; border-radius:8px; display:flex; align-items:center;">
<img src="https://cdn-icons-png.flaticon.com/512/7865/7865796.png" style="height:30px; padding-right:10px;"></img>
    <p style="color:white; margin:0; font-size:20px;font-weight:bold">Tecnologias Utilizadas:</p>
</div>

###

<div style="background:black; color:white; padding:15px; border-radius:8px; display:flex; align-items:center; justify-content:space-between;">
...
<div style="background:black; color:white; padding:15px; border-radius:8px; display:flex; align-items:center;">
<img src="https://cdn-icons-png.flaticon.com/512/3967/3967165.png" style="height:30px; padding-right:10px;"></img>
    <p style="color:white; margin:0; font-size:20px;font-weight:bold">Pré-requisitos:</p>
</div>
...
<div style="background:black; color:white; padding:15px; border-radius:8px; display:flex; align-items:center;">
<img src="https://cdn-icons-png.flaticon.com/512/3798/3798294.png" style="height:30px; padding-right:10px;"></img>
    <p style="color:white; margin:0; font-size:20px;font-weight:bold">Como instalar:</p>
</div>
